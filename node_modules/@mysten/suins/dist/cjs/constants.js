...
const getConfigType = (suinsPackageV1, innerType) => `${suinsPackageV1}::suins::ConfigKey<${innerType}>`;
const getDomainType = (suinsPackageV1) => `${suinsPackageV1}::domain::Domain`;
const getPricelistConfigType = (suinsPackageId) => `${suinsPackageId}::pricing_config::PricingConfig`;
const getRenewalPricelistConfigType = (suinsPackageId) => `${suinsPackageId}::pricing_config::RenewalConfig`;
const getCoinDiscountConfigType = (paymentPackageId) => `${paymentPackageId}::payments::PaymentsConfig`;
const mainPackage = {
  mainnet: {
